<div class="w3-container w3-quarter w3-hide-small" id="offer">
  <?php
  ...
  ?>
  <div class="w3-container w3-center offers-image w3-black">
      <a href="#<?php echo $fetchItems['picture'] ?>"><img src="assets/services/<?php echo $fetchItems['picture'] ?>" alt="<?php echo $fetchItems['picture'] ?>" class="w3-col"></a>
  </div>
  <?php $i++;
  } ?>
</div>
<div class="w3-container w3-threequarter w3-hide-small" id="offer">
  ...
  while ($fetchItems = mysqli_fetch_assoc($selectItems)) {
    ...
    $replacedText = str_replace($searchText, $replaceText, $fetchedText);
  ?>
  <div class="w3-container offers-image w3-black" id="<?php echo $fetchItems['picture'] ?>">
      <img src="assets/services/<?php echo $fetchItems['picture'] ?>" alt="<?php echo $fetchItems['picture'] ?>" class="w3-col s6">
...
<div class="w3-container w3-threequarter w3-hide-large w3-hide-medium">
  ...
  while ($fetchItems = mysqli_fetch_assoc($selectItems)) {
    ...
    $replacedText = str_replace($searchText, $replaceText, $fetchedText);
  ?>
  <div class="w3-container offers-image w3-black w3-center" id="<?php echo $fetchItems['picture'] ?>">
      <img src="assets/services/<?php echo $fetchItems['picture'] ?>" alt="<?php echo $fetchItems['picture'] ?>" class="w3-col">
